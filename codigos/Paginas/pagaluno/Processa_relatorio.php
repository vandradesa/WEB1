...
session_start();
    ...
    if(isset($_POST['botao_relatorio'])){
        ...
        $select_de_projetos = "SELECT * FROM projeto WHERE nome='$projAlu'"; //Aqui fazemos NOSSA LIGAÇÃO PHP como o MYSQL, trazendo os dados da tabela projeto.
        ...
        $linha_projetos = mysqli_fetch_row($resultado_s_projetos);
                $id_proj = $linha_projetos;
        
         
        

            $result_usuario = "INSERT INTO relatorio ( id_usuario, id_projeto, envio, horas_realizadas, descricao_atividades) VALUES ('$id_user', '$id_proj', NOW(), '$horas_relatorio', '$descri_relatorio')";
